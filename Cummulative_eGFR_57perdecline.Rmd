---
title: "Commulative outcomes with 57% egfr decline and Dialysis or Transplant and true eskd for renel 2"
...
for (year in 1:10){
  ...
  rawdata$outcome = ((t1-t0)/t0 < -.57) | (year>= rawdata$sa_allc_cric_time_renal2_v3y0)
...
## Cumulative outcomes with 40% EGFR decline (in %)
